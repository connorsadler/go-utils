...
var _ KeyProducer = make(myintslice, 0)

func (m myintslice) CalcKey() string {
	// myintslice items are considered equivalent if they contain same items, in any order
	slices.Sort(m)
	return fmt.Sprintf("%v", m)
}

func TestAllSet2(t *testing.T) {
	hs := NewSet2[myintslice]()
